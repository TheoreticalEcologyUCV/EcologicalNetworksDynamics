...
## CONUCO ORIGINAL TOPOLOGY – INTERACTIONS WITH CONDITIONAL OUTCOME 
...
#As<- MatrizAlfa(MatrizInteraccion, As, Bs, Cs, Es, Fs, Ns) # This is for confirmation  
